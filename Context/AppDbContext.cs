...
public partial class AppDbContext : DbContext
{
    ...
    public virtual DbSet<ClassMed> ClassMeds { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    {
        modelBuilder.Entity<ClassMed>(entity =>
        {
            entity.HasKey(e => e.CodClasse).HasName("class_med_pkey");

            entity.ToTable("class_med");
        ...
        {
            entity.HasKey(e => e.CodMed).HasName("mat_med_pkey");

            entity.ToTable("mat_med");

            entity.HasIndex(e => e.CodMed, "idx_cod_matmed");
        ...
        {
            entity.HasKey(e => e.CodMed).HasName("medico_pkey");

            entity.ToTable("medico");

            entity.HasIndex(e => e.CodCrm, "idx_cod_crm");

            entity.HasIndex(e => e.CodMed, "idx_cod_medico");
